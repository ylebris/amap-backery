/*
  ...
  This migration contains the complete database schema for the AMAP application.
  All previous migrations have been consolidated into this single file for clarity
  and maintainability.

  1. Core Tables
    - Users and authentication
    - AMAPs and memberships
    - Products and catalogs
    - Orders and payments
  
  2. Features
    - Product catalogs with versioning
    - Order management
    - Payment processing
    - Delivery scheduling
